...
void Our_Passenger::set_Seat(int seatRow, char seatColumn, char status, int numRows, int numSeats) {  //Used to set up seat in seatmap, allows use of pointers from pasenger instance
